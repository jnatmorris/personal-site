            ...
            <div className="space-y-[3vh] lg:px-[0.75vw]">
                <div>
                    ...
                    <h4 className="text-2xl font-normal leading-relaxed lg:leading-loose">
                        ...
                        was my first ReactJS project. Allows for
                        multidirectional communication between clients and
                        server using an exspress and socketio backend. Feel free
                        to try it out{" "}
                        <a
                        ...
                        . As my first project, it has only been styled for
                        mobile devices. One day when I may come back to it.
                    </h4>
                </div>
