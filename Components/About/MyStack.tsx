    ...
    <div className="space-y-[3vh] lg:px-[0.75vw]">
        <div>
            <div className="flex  space-x-[1vw]">
                ...
                <h2 className="self-end  text-xl font-normal leading-relaxed text-slate-700 underline underline-offset-2 dark:text-slate-100/90 lg:py-[2vh] lg:leading-loose">
                    My stack
                </h2>
            </div>
