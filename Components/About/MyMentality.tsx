...
const MyMentality: React.FC = () => (
    <div className=" lg:px-[0.75vw]">
        <div className="flex items-center space-x-[1vw]">
            ...
            <h2 className="align-bottom text-xl font-normal leading-relaxed text-slate-700 underline underline-offset-2 dark:text-slate-100/90 lg:py-[2vh] lg:leading-loose">
                My mentality
            </h2>
        </div>
